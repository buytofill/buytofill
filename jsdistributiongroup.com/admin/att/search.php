<?php
    ...
    while ($row = $result->fetch_assoc()){
        $panel .= '
        <div class="flex mb-2 overflow-hidden" style="align-items: center;">
            <div class="bg-white rounded-3xl flex min-w-[100px] max-w-[100px] max-h-[100px] items-center justify-center bg-[--one] p-4 box-border">
                <img class="max-h-[100px] box-border p-3 max-w-[100px]" src="'.$row['img'].'">
            </div>
            <div class="p-2 box-border flex flex-col justify-between w-full">
                <div class="transition-[10s ease-in]">
                    <p class="checktext">'.$row['name'].'</p>
                </div>
                <div class="flex">
