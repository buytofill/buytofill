    ...
    <body>
        <header>
            ...
            <button id="hp-o" title="mobile-menu" type="button">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill="currentColor" d="m1.6 5h14c.3 0 .5-.2.5-.5 0-.3-.2-.5-.5-.5h-14c-.2 0-.5.2-.5.5 0 .3.3.5.5.5m0 3.5h14c.3 0 .5-.2.5-.5 0-.3-.2-.5-.5-.5h-14c-.2 0-.5.2-.5.5 0 .3.3.5.5.5m0 3.5h14c.3 0 .5-.2.5-.5 0-.3-.2-.5-.5-.5h-14c-.2 0-.5.2-.5.5 0 .3.3.5.5.5"></path>
                </svg>
            </button>
            <p>buytofill</p>
            <div id="hp-l">
        ...
        <main>
            ...
            <aside style="overflow:hidden;">
                <img src="assets/images/vr.webp" style="height:100%;">
            </aside>
        </main>
